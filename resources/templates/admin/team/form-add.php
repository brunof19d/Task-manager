<?php require_once __DIR__ . '/../../../includes/header-admin.php'; ?>
    ...
    <div class="container">
        ...
        <form method="POST" class="card" action="/save-employee" enctype="multipart/form-data">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="formOccupation" class="form-control" name="occupation" placeholder="Insert the employee's position here ..." />
                    </div>
                    <div class="form-group col-md-6">
                        <label>&nbsp;</label>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea id="formDescription" name="text" class="form-control" cols="30" rows="10" placeholder="Insert the testimonial text here ..."></textarea>
                    </div>
